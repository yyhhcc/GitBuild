...
<form onsubmit="return verifyForm(this);" target="_self" name="billship" method="post" action="/PlantsByWebSphere/servlet/ShoppingServlet?action=orderinfodone">
<table border="0" cellpadding="0" cellspacing="5" width="100%">
  <tr>
    <td><p class="trail"><a class="trail" class="footer" href="/PlantsByWebSphere/promo.html" target="work">Home</a> &gt; <a class="trail" class="footer" href="/PlantsByWebSphere/servlet/ShoppingServlet?action=gotocart" target="work">Shopping Cart</a></p></td>
  </tr>
  <tr>
    <td width="100%">
...
<tbody>
  <TR>
    ...
    <TD width="100%"><P><input type="text" name="bname" size="20" value="<%=customerInfo.getFirstName() + " " + customerInfo.getLastName()%>"></P></TD>
  </TR>
  <tr>
    <td nowrap width="120"><p><label for="baddr1">Address Line 1&nbsp;</label></td>
    <td><img border="0" src="/PlantsByWebSphere/images/required.gif" width="10" height="15" alt="Required indicator"></td>
    <td width="100%"><p><input type="text" name="baddr1" size="20" value="<%=customerInfo.getAddr1()%>"></p></td>
  </tr>
  <tr>
    <td nowrap><p><label for="baddr2">Address Line 2&nbsp;</label></td>
    <td></td>
    <td><p><input type="text" name="baddr2" size="20" value="<%=customerInfo.getAddr2()%>"></p></td>
  </tr>
  <tr>
    <td nowrap><p><label for="bcity">City&nbsp;</label></td>
    <td><img border="0" src="/PlantsByWebSphere/images/required.gif" width="10" height="15" alt="Required indicator"></td>
    <td><p><input type="text" name="bcity" size="20" value="<%=customerInfo.getAddrCity()%>"></p></td>
  </tr>
  <tr>
    <td nowrap><p><label for="bstate">State&nbsp;</label></td>
    <td><img border="0" src="/PlantsByWebSphere/images/required.gif" width="10" height="15" alt="Required indicator"></td>
    <td><p><input type="text" name="bstate" size="20" value="<%=customerInfo.getAddrState()%>"></p></td>
  </tr>
  <tr>
...
<caption>Shipping Method</caption>
  ...
  <tr>
    ...
    <td><p><select size="1" name="ccexpiresyear">
        ...
        <option value="2006">2006</option></select></p></td>
  </tr>
  <tr>
  ...
  <TR>
    ...
    <td></td>
    <td>
        <input type="image" alt="Continue" src="/PlantsByWebSphere/images/button_continue.gif"><a href="javascript:verifyForm(this);"></a>
    </td>
  </tr>
</table></td>
  </tr>
...
<table bgcolor="#669966" border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    <td width="1"><img border="0" src="/PlantsByWebSphere/images/1x1_trans.gif" width="1" height="1" alt=""></td>
  </tr>
</table>
</form>
<br>
<table border="0" cellpadding="5" cellspacing="0" width="100%">
  <tr>
    <td>
      <img src="/PlantsByWebSphere/images/poweredby_WebSphere.gif" alt="Powered by WebSphere">
    </td> 
    <td>
      <p class="footer"><a class="footer" href="/PlantsByWebSphere/servlet/ShoppingServlet?action=shopping&category=0" target="work">Flowers</a>&nbsp;&nbsp;:&nbsp;
                  <a class="footer" href="/PlantsByWebSphere/servlet/ShoppingServlet?action=shopping&category=1" target="work">Fruits &amp; Vegetables</a>&nbsp;&nbsp;:&nbsp;
                  <a class="footer" href="/PlantsByWebSphere/servlet/ShoppingServlet?action=shopping&category=2" target="work">Trees</a>&nbsp;&nbsp;:&nbsp;
                  <a class="footer" href="/PlantsByWebSphere/servlet/ShoppingServlet?action=shopping&category=3" target="work">Accessories</a><br>
                  <a class="footer" href="/PlantsByWebSphere/index.html" target="_top">Home</a>&nbsp;&nbsp;:&nbsp;
                  <a class="footer" href="/PlantsByWebSphere/cart.jsp" target="work">Shopping Cart</a>&nbsp;&nbsp;:&nbsp;
